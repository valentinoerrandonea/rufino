...
- `/Users/val/Files/vaultlentino/_meta/relationship-vocab.md` — typed relations
...
Walk these paths:
- `/Users/val/Files/vaultlentino/proyectos/**/*.md` (excl `_*`)
- `/Users/val/Files/vaultlentino/rufino/**/*.md` (excl `_*`, excl files in raíz of `rufino/`)
- `/Users/val/Files/vaultlentino/sesiones/*.md`
- `/Users/val/Files/vaultlentino/conceptos/*.md`
...
This is critical. The body is whatever Claude or Val wrote. Light cron does NOT add augmentation, does NOT reformat sections, does NOT add "## Resumen estructurado" / "## Análisis" / "## Implicaciones".
